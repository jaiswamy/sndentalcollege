...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/sndentalcollege/domains/sndentalcollege.org/awstats/.data"
	# Other possible directories :				"/usr/local/etc/awstats",
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/sndentalcollege/domains/sndentalcollege.org/awstats/.data",
